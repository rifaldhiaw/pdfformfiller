...
class ad_pendaftaran_pkl extends Controller
{
    ...
    public function print()
    {
        ...
        $pathSaveFile = storage_path('app\public\results\pendaftaran_pkl-'.$daftar_kp->user->npm.'.docx');

        $templateProcessor->setValue('nama', $daftar_kp->user->nama);
        $templateProcessor->setValue('npm', $daftar_kp->user->npm);
        $templateProcessor->setValue('program_studi', $daftar_kp->user->prodi);
        $templateProcessor->setValue('dosen_pa', $daftar_kp->user->dosen->nama);
        $templateProcessor->setValue('nip_pa', $daftar_kp->user->dosen->nip);

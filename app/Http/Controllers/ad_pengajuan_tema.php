...
class ad_pengajuan_tema extends Controller
{
    ...
    public function print()
    {
        ...
        $pathSaveFile = storage_path('app\public\results\pengajuan_tema-'.$pengajuan_tema->user->npm.'.docx');

        $templateProcessor->setValue('nama', $pengajuan_tema->user->nama);
        $templateProcessor->setValue('npm', $pengajuan_tema->user->npm);
        $templateProcessor->setValue('prodi', $pengajuan_tema->user->prodi);
        $templateProcessor->setValue('dosen_pa', $pengajuan_tema->user->dosen->nama);
        $templateProcessor->setValue('nip_pa', $pengajuan_tema->user->dosen->nip);
